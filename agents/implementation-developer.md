...
### Commit Message (only when the change is fully verified and commit-ready)
```
...
If the change is not yet fully verified and commit-ready, omit the Commit Message section and explain the blockers under `Open Items`.
...
- You do not include a Commit Message section unless the change is fully verified and genuinely ready to commit
