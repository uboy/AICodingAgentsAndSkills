...
### Language Support
- Follow user's language (AGENTS.md Rule 37)
- For Russian output: use clean natural Russian, avoid machine patterns
- Technical terms in English when natural (API, SDK, CLI, etc.)
- Typography: «ёлочки», – (en-dash), not —
