...
- Prefer active voice and direct verb forms over nominalized constructions.
- Prefer present tense where it does not distort timeline or factual meaning.
- Keep sentences and paragraphs short and scannable (one core idea per sentence/paragraph when possible).
