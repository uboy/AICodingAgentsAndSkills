...
## Delivery Contract Override

Text-processing skills produce **content, not code**. When this guardrail is referenced, the following AGENTS.md rules do NOT apply:

- **Rule 17** (commit message block) — no code to commit
- **Rule 31** (documentation contract for code changes) — no code changes
- **Rule 29** (automated testing) — text output, not executable

Output is the final text deliverable. No git operations, commit messages, or staging required.

Skills covered by this override:
- `text-cleanup`
- `text-humanize`
- `lecture-transcript`
- `meeting-notes`
- `homework-management`
- Any skill referencing this guardrail for text/transcript processing
