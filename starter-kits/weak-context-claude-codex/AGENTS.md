...
1. If local `coordination/tasks.jsonl` exists, read it.
...
3. Checklist in local `coordination/tasks.jsonl`.
4. Implementation in micro-steps.
5. Optional local review handoff in `coordination/handoffs/`.
...
- update checklist item status in local `coordination/tasks.jsonl`,
