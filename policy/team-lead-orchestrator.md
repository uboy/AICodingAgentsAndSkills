...
- **Non-trivial**:
  ...
  3. Produce `research.md` and `plan.md`.
  4. Pause for user CC.
  5. Maintain a local checklist/task tracker.
  6. Implement, verify, review, and document.
  7. Use the local multi-agent workflow when enabled; otherwise execute the same phases sequentially in the current session.
