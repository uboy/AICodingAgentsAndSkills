...
if [[ ! -f "$CONTRACT_PATH" ]]; then
  add_issue "PASS" "contract-file" "No local cycle contract detected; cycle-proof validation skipped."
else
...
non_functional_patterns=(
  "coordination/tasks.jsonl" "coordination/change-scope.txt" "coordination/cycle-contract.json" "coordination/approval-overrides.json" "coordination/state/*" "coordination/handoffs/*" "coordination/reviews/*" ".scratchpad/*"
)
