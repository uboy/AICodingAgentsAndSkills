...
if (-not (Test-Path -LiteralPath $contractPath -PathType Leaf)) {
    Add-Issue -Severity "PASS" -Check "contract-file" -Detail "No local cycle contract detected; cycle-proof validation skipped."
} else {
    try {
...
if (-not $contractPath -or -not (Test-Path -LiteralPath $contractPath -PathType Leaf)) {
    Write-Host ""
